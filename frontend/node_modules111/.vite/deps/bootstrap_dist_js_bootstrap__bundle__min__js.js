...
var require_bootstrap_bundle_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	(function(t, e) {
		"object" == typeof exports && "undefined" != typeof module ? e(exports, __require("jquery")) : "function" == typeof define && define.amd ? define(["exports", "jquery"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).bootstrap = {}, t.jQuery);
			...
			modifiers: {
				...
				computeStyle: {
					...
					fn: function(t, e) {
						...
						return t.attributes = X({}, { "x-placement": t.placement }, t.attributes), t.styles = X({}, u, t.styles), t.arrowStyles = X({}, t.offsets.arrow, t.arrowStyles), t;
					},
					gpuAcceleration: !0,
					x: "bottom",
					y: "right"
		...
		var Ot = "dropdown", xt = i.default.fn[Ot], jt = /* @__PURE__ */ new RegExp("38|40|27"), Lt = {
			offset: 0,
			flip: !0,
		...
		var Yt = "tooltip", zt = i.default.fn[Yt], Xt = /* @__PURE__ */ new RegExp("(^|\\s)bs-tooltip\\S+", "g"), Kt = [
			"sanitize",
			"whiteList",
			"sanitizeFn"
		], Gt = {
		...
		var ee = "popover", ne = i.default.fn[ee], ie = /* @__PURE__ */ new RegExp("(^|\\s)bs-popover\\S+", "g"), oe = a({}, te.Default, {
			placement: "right",
			trigger: "click",
			content: "",
